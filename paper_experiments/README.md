...
- `probe_paper`、`pilot_paper` 和 `full_paper` 都运行同一完整论文方法、攻击、baseline、消融、统计和证据 schema, 并使用同一个 `FPR=0.1` 协议。三者只允许 Prompt / test 数量70 / 34、700 / 340、7000 / 3400及由样本规模带来的统计强度不同。
