...
- 可机读方法定义摘要: `aa1fe3b81f1763403b58bb85c01a44c048b8d2b0916f3a3d9cf72c2275a4fd7c`。
...
- 方法追踪规范摘要: `406d491e24edefd1d1e0d511287552a6130f1519626c71bda43a36ed6dca95c4`。
...
- 当前仍需把注意力配准预门禁参数纳入唯一 YAML、方法定义和结果摘要, 使检测器语义可逐字段重建。
...
```text
pytest -q
1191 passed, 8 skipped, 68 deselected
