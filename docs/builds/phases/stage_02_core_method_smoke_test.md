...
1. `outputs/core_method_synthetic_smoke/synthetic_event_records.jsonl`
2. `outputs/core_method_synthetic_smoke/core_smoke_metrics.json`
3. `outputs/core_method_synthetic_smoke/core_smoke_summary.md`
4. `outputs/core_method_synthetic_smoke/manifest.local.json`
