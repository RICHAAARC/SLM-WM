...
1. `outputs/local_stage01_core_primitives/core_primitive_summary.json`
2. `outputs/local_stage01_core_primitives/synthetic_core_records.jsonl`，由外层脚本生成
3. `outputs/local_stage01_core_primitives/manifest.local.json`
