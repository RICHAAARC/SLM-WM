...
PACKAGE_EXTRA_PATHS = (
    ...
    "paper_workflow/colab_utils/dependency_check.py",
    "paper_workflow/colab_utils/paper_run_environment.py",
    ...
    "paper_workflow/notebooks/dependency_lock_review_run.ipynb",
)
