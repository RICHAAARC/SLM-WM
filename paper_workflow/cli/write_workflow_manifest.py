"""写入 Colab Drive workflow manifest 文件集合。"""
...
from paper_workflow.colab_utils.drive_workflow import write_workflow_manifest_files
from paper_workflow.colab_utils.manifest_io import stable_json_text


def build_parser() -> argparse.ArgumentParser:
    """构造命令行参数解析器。"""
    parser = argparse.ArgumentParser(description="写入 Drive workflow manifest。")
