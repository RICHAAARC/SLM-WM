"""Colab 真实 attention 几何捕获 helper。"""
...
PACKAGE_EXTRA_PATHS = (
    "paper_workflow/attention_geometry_capture_run.ipynb",
    "paper_workflow/colab_utils/attention_geometry_capture.py",
    "scripts/write_attention_geometry_outputs.py",
...
def write_attention_capture_outputs(config: AttentionGeometryRunConfig, root: str | Path = ".") -> dict[str, Any]:
    ...
    manifest = build_artifact_manifest(
        ...
        rebuild_command="运行 paper_workflow/attention_geometry_capture_run.ipynb",
        metadata={
